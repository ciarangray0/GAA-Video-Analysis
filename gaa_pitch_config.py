...
GAA_PITCH_LENGTH = 145.0  # meters  (y)
...
GAA_PITCH_VERTICES = {
    ...
    # small arc
    "left_small_arc_bottom": (33.0, GAA_PITCH_LENGTH - 20.0),
    "left_small_arc_top": (33.0, 20.0),
    "right_small_arc_bottom": (52.0, GAA_PITCH_LENGTH - 20.0),
    "right_small_arc_top": (52.0, 20.0),
